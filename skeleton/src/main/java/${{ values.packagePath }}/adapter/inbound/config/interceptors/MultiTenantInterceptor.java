package {{ values.groupId }}.{{ values.packageName }}.adapter.inbound.config.interceptors;

import {{ values.groupId }}.{{ values.packageName }}.core.config.components.MultiTenantContext;
