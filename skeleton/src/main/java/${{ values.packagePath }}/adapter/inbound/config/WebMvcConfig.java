...
import {{ values.groupId }}.{{ values.packageName }}.adapter.inbound.config.interceptors.MultiTenantInterceptor;
import {{ values.groupId }}.{{ values.packageName }}.adapter.inbound.config.interceptors.TracingInterceptor;
